...
HD_PWD='/home/benjamin/PynqNet/ZyboEthernet/ZyboEthernet.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log ZyboEthernet_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ZyboEthernet_wrapper.tcl
