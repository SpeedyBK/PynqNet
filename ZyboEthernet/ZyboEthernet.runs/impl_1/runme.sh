...
HD_PWD='/home/benjamin/PynqNet/ZyboEthernet/ZyboEthernet.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ZyboEthernet_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ZyboEthernet_wrapper.tcl -notrace
