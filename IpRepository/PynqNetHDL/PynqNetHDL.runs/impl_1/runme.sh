...
HD_PWD='/home/benjamin/PynqNet/IpRepository/PynqNetHDL/PynqNetHDL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PynqNetHDLTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PynqNetHDLTop.tcl -notrace
