...
HD_PWD='/home/benjamin/PynqNet/IpRepository/PynqNetHDL/PynqNetHDL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PynqNetHDLTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PynqNetHDLTop.tcl
