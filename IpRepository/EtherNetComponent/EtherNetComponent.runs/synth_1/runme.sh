...
HD_PWD='/home/benjamin/Repositories/PynqNet/IpRepository/EtherNetComponent/EtherNetComponent.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log EtherNetTopLevel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source EtherNetTopLevel.tcl
