...
HD_PWD='/home/benjamin/PynqNet/IpRepository/CRC-Generator/CRC-Generator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log crc_generator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source crc_generator.tcl
