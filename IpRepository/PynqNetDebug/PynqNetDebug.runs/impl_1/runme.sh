...
HD_PWD='/home/benjamin/PynqNet/IpRepository/PynqNetDebug/PynqNetDebug.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PynqNetDebugTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PynqNetDebugTop.tcl -notrace
