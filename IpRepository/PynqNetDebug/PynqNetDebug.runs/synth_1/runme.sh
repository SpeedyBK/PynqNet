...
HD_PWD='/home/benjamin/PynqNet/IpRepository/PynqNetDebug/PynqNetDebug.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PynqNetDebugTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PynqNetDebugTop.tcl
