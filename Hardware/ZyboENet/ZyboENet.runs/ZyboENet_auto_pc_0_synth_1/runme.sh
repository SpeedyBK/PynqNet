...
HD_PWD='/home/benjamin/Repositories/PynqNet/Hardware/ZyboENet/ZyboENet.runs/ZyboENet_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ZyboENet_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ZyboENet_auto_pc_0.tcl
