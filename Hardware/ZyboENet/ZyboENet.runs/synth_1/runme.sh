...
HD_PWD='/home/benjamin/Repositories/PynqNet/Hardware/ZyboENet/ZyboENet.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ZyboENet_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ZyboENet_wrapper.tcl
