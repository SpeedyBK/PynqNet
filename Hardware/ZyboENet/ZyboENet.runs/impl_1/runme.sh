...
HD_PWD='/home/benjamin/Repositories/PynqNet/Hardware/ZyboENet/ZyboENet.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ZyboENet_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ZyboENet_wrapper.tcl -notrace
