...
HD_PWD='/home/benjamin/Repositories/PynqNet/Hardware/ZyboENet/ZyboENet.runs/ZyboENet_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ZyboENet_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ZyboENet_xbar_0.tcl
