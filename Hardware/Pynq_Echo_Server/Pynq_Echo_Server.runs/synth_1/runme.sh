...
HD_PWD='/home/benjamin/Repositories/PynqNet/Hardware/Pynq_Echo_Server/Pynq_Echo_Server.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Echo_Server_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Echo_Server_wrapper.tcl
