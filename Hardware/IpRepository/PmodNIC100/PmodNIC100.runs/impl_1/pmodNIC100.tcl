...
set rc [catch {
  ...
  add_files -quiet /home/benjamin/Repositories/PynqNet/Hardware/IpRepository/PmodNIC100/PmodNIC100.runs/synth_1/pmodNIC100.dcp
  ...
  link_design -top pmodNIC100 -part xc7z020clg400-1
...
set rc [catch {
  ...
  catch { write_mem_info -force pmodNIC100.mmi }
  write_bitstream -force pmodNIC100.bit 
  catch {write_debug_probes -quiet -force pmodNIC100}
  catch {file copy -force pmodNIC100.ltx debug_nets.ltx}
