...
set id 2
set name FIR16BitA_fmul_32ns_32ns_32_4_max_dsp_1
...
set id 3
set name FIR16BitA_sitofp_32s_32_6_1
...
set ID 6
set hasByteEnable 0
set MemName FIR16BitA_m_filterArray
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 7 \
			corename FIR16BitA_BUS_A_axilite \
			name FIR16BitA_BUS_A_s_axi \
			ports {$port_BUS_A} \
			op interface \
			is_flushable 0 \ 
		} "
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler FIR16BitA_BUS_A_s_axi
}
