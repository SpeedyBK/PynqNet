...
HD_PWD='/home/benjamin/Repositories/PynqNet/Hardware/PmodEnetRef/PmodEnetRef.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log eth_driver.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source eth_driver.tcl
