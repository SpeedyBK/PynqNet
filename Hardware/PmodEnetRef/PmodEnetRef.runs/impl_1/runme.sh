...
HD_PWD='/home/benjamin/Repositories/PynqNet/Hardware/PmodEnetRef/PmodEnetRef.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log eth_driver.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source eth_driver.tcl -notrace
