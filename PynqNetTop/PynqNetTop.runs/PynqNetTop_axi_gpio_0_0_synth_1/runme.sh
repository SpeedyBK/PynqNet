...
HD_PWD='/home/benjamin/PynqNet/PynqNetTop/PynqNetTop.runs/PynqNetTop_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PynqNetTop_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PynqNetTop_axi_gpio_0_0.tcl
