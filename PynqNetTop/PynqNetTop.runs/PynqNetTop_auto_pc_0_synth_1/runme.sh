...
HD_PWD='/home/benjamin/PynqNet/PynqNetTop/PynqNetTop.runs/PynqNetTop_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PynqNetTop_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PynqNetTop_auto_pc_0.tcl
