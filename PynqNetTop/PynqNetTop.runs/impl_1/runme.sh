...
HD_PWD='/home/benjamin/PynqNet/PynqNetTop/PynqNetTop.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PynqNetTop_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PynqNetTop_wrapper.tcl -notrace
