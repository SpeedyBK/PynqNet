...
synth_design -top PynqNetTop_wrapper -part xc7z020clg400-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef PynqNetTop_wrapper.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file PynqNetTop_wrapper_utilization_synth.rpt -pb PynqNetTop_wrapper_utilization_synth.pb"
