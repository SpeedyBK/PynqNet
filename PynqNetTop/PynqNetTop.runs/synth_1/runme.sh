...
HD_PWD='/home/benjamin/PynqNet/PynqNetTop/PynqNetTop.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PynqNetTop_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PynqNetTop_wrapper.tcl
